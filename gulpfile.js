...
//    https : true,
    middleware: function (connect, options) {
      ...
      var proxy = new $.connectProxy(options);
...
gulp.task('default', ['data','images', 'html','scripts', 'styles', 'serve', 'watch']);

// waits until clean is finished then builds the project
gulp.task('build', ['clean'], function(){
  gulp.start(['data','images', 'html','scripts','styles']);
});
